...
def from_pretrained(name: str):
    ...
    Note :
    This only works with the state-spaces/mamba-XXX model family, because there is a pytorch_model.bin file in the HF repo.
    ...
    pass the state_dict to a MambaLM. I see no other way around, unfortunately, (this is how it's done in jamba.py)
